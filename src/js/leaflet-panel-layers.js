(function (factory) {
	...
	L.Control.PanelLayers = L.Control.Layers.extend({
		...
		_createItem: function (obj) {
			...
			// var e = L.Control.PanelLayers.prototype._createItem.call(this, obj);
		...
		_insertInfoButton: function () {

			let i = L.DomUtil.create("img", "layer-info-img");
			i.alt = "\u{1F6C8}";
			i.title = "Attribution";
			L.DomEvent.on(i, "click", function () { alert('@ Attribution') });
			// 	$("#myModal2").modal();
			// }, this._map)
			// e.insertBefore(i, e.firstElementChild),
